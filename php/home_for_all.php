    ...
    <body>
        ...
        <div id="about" class="popup">
            <div class="popup_content">
                <span class="close1" onclick="closePopup1()" style="font-size:30px; color:white;">&times;</span>
                <h1 style="color:white;">About Recipebook</h1>
            </div>
        </div>
        ...
        <div id="signup_login_popup" class="popup">
            <div class="popup_content">
                <span class="close2" onclick="closePopup2()" style="font-size:30px; color:white;">&times;</span><br/>
