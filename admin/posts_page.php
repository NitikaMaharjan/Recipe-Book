...
if (isset($_POST['delete_post'])) {
    ...
    header("Location: /Recipebook/Recipe-Book/admin/posts_page.php?user_id=$user_id");
    exit();
}
?>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='10' style='text-align:center;'>No posts found for this user</td></tr>";
            }
            ?>
        </tbody>
    </table>
